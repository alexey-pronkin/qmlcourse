...
# $$
# 
# где $p$ -- импульс, $r$ -- радиус орбиты электрона, $h$ -- константа Планка, $n$ -- любое целое число. Если применить этот постулат к атому водорода -- паре из протона и электрона, то получится, что:
# 
